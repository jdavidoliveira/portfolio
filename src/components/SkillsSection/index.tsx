...
export default function SkillsSection() {
  return (
    <section className="w-full flex flex-col py-48 items-center justify-center bg-primary-bg dark:bg-dark-primary-bg">
      <div className="w-full flex items-center justify-center">
        <div className="w-full flex flex-col items-center gap-8">
          <h1 className="text-3xl font-medium dark:text-white">
            Algumas tecnologias que uso no meu dia-a-dia
          </h1>
          <div className="bg-secondary-bg flex items-center justify-between w-full sm:w-auto gap-2 sm:gap-6 h-32 sm:p-10 p-6 rounded-lg">
            <StackCard
              name="TypeScript"
