...
export const experience: IExperience[] = [
  ...
  },
  {
    ...
    description: `Atuei desenvolvendo novas aplicações, e implementando aplicações ja existentes. Desde aplicações desktop para problemas internos, como tratamento de imagens, e controle de avaliações de alunos, até aplicações que consumiam API's REST e SOAP.`
  }
]
